...
public class SelectVisit extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!temp.equals(loginID)){
			...
			if (checkPageFrame(pageContain)){
				page = service.selectVisit(Integer.parseInt(pageIndex), Integer.parseInt(pageContain), 5);
			}else{
				page = service.selectVisit(Integer.parseInt(pageIndex), 10, 5);
			}
			if(page == null){
